...
public class MediaProcessingWorkScheduler extends Worker {
    ...
    public Result doWork() {
        ...
        try (ContentProviderClient cpc = mContext.getContentResolver().acquireContentProviderClient(
            ...
            Optional<DatabaseHelper> dbHelper = provider.getDatabaseHelper(EXTERNAL_DATABASE_NAME);
            if (dbHelper.isEmpty()) {
